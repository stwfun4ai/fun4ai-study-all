...
![markword](https://www.cnblogs.com/xmanblue/p/markword.png)
...
​		否则并发thread1发生指令重排（2 3步）半初始化对象,此时thread2判断对象不为空直接使用半初始化状态的对象，默认参数为（0，0.0，空）
