...
![factory-1](D:\Java\document\study\images\factory-1.png)
...
![factory-1](D:\Java\document\study\images\abstract-factory-1.png)
...
![abstract-factory-2](D:\Java\document\study\images\abstract-factory-2.png)

当涉及到这种产品族的问题的时候，就需要抽象工厂模式来支持了。我们不再定义 CPU 工厂、主板工厂、硬盘工厂、显示屏工厂等等，我们直接定义电脑工厂，每个电脑工厂负责生产所有的设备，这样能保证肯定不存在兼容问题。

![abstract-factory-3](D:\Java\document\study\images\abstract-factory-3.png)
...
![proxy](D:\Java\document\study\images\proxy-1.png)
...
![adapter-1](D:\Java\document\study\images\adapter-1.png)

### 类适配器模式

废话少说，直接上图：

![adapter-1](D:\Java\document\study\images\adapter-2.png)
...
![adapter-5](D:\Java\document\study\images\adapter-5.png)
...
![bridge-1](D:\Java\document\study\images\bridge-1.png)
...
![decorator-1](D:\Java\document\study\images\decorator-1.png)
...
![decorator-2](D:\Java\document\study\images\decorator-2.png)

到这里，大家应该已经清楚装饰模式了吧。

下面，我们再来说说 java IO 中的装饰模式。看下图 InputStream 派生出来的部分类：

![decorator-3](D:\Java\document\study\images\decorator-3.png)
...
![strategy-1](D:\Java\document\study\images\strategy-1.png)
